...
public class BsLoginCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public LoginCB acceptUniqueOf(Long userId) {
     ...
     * <pre>
     * <span style="color: #0000C0">loginBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">login</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">login</span>.<span style="color: #CC4747">getUser()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<LoginCQ> {
         ...
         */
        public SpecifiedColumn columnLoginFlg() { return doColumn("LOGIN_FLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLastLogoutDatetime() { return doColumn("LAST_LOGOUT_DATETIME"); }
