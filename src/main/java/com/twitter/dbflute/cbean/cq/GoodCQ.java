...
import com.twitter.dbflute.cbean.cq.bs.BsGoodCQ;

/**
 * The condition-query of GOOD.
 * <p>
 ...
 */
public class GoodCQ extends BsGoodCQ {
     ...
     */
    public GoodCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
