 ...
 */
public abstract class BsLoginBhv extends AbstractBehaviorReadable<Login, LoginCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Login> selectByUniqueOf(Long userId) {
        return facadeSelectByUniqueOf(userId);
    }

    protected OptionalEntity<Login> facadeSelectByUniqueOf(Long userId) {
        return doSelectByUniqueOf(userId, typeOfSelectedEntity());
    }

    protected <ENTITY extends Login> OptionalEntity<ENTITY> doSelectByUniqueOf(Long userId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(userId), tp), userId);
    }

    protected LoginCB xprepareCBAsUniqueOf(Long userId) {
     ...
     */
    public List<User> pulloutUser(List<Login> loginList)
    { return helpPulloutInternally(loginList, "user"); }
     ...
     */
    public List<Long> extractUserIdList(List<Login> loginList)
    { return helpExtractListInternally(loginList, "userId"); }
