 ...
 */
@Configuration
@ComponentScan(value = "com.twitter.dbflute.exbhv", lazyInit = true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.twitter.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.twitter.dbflute.allcommon.ImplementedInvokerAssistant();
    }
