package com.twitter.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("GOOD", "com.twitter.dbflute.bsentity.dbmeta.GoodDbm");
        tmpMap.put("LOGIN", "com.twitter.dbflute.bsentity.dbmeta.LoginDbm");
        tmpMap.put("MUTTER", "com.twitter.dbflute.bsentity.dbmeta.MutterDbm");
        tmpMap.put("RELATION", "com.twitter.dbflute.bsentity.dbmeta.RelationDbm");
        tmpMap.put("USER", "com.twitter.dbflute.bsentity.dbmeta.UserDbm");
